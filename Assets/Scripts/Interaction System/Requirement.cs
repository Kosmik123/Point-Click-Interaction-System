...
namespace PointAndClick
{
    ...
    public class FlagRequirement : Requirement
    {
        ...
        public override bool IsFulfilled()
        {
            return InteractionController.GetFlag(flagId) == state;
        }
    ...
    public class VariableValueRequirement : Requirement 
    {
        ...
        public override bool IsFulfilled()
        {
            return InteractionController.CompareVariableWithValue(variableId, compare, value);
        }
    ...
    public class VariablesCompareRequirement : Requirement
    {
        ...
        public override bool IsFulfilled()
        {
            return InteractionController.CompareVariables(variable1, compare, variable2);
        }
